...
define(['./workbox-15ec2ecc'], (function (workbox) { 'use strict';
  ...
  workbox.registerRoute(/^https:\/\/quran-endpoint\.vercel\.app\/.*/i, new workbox.CacheFirst({
    "cacheName": "quran-endpoint",
    plugins: [new workbox.ExpirationPlugin({
      maxEntries: 200,
  ...
  workbox.registerRoute(/^https:\/\/ahegazy\.github\.io\/.*/i, new workbox.CacheFirst({
    "cacheName": "azkar-v2",
    plugins: [new workbox.ExpirationPlugin({
      maxEntries: 20,
  ...
  workbox.registerRoute(/^https:\/\/cdn\.jsdelivr\.net\/gh\/fawazahmed0\/.*/i, new workbox.CacheFirst({
    "cacheName": "hadith-v2",
    plugins: [new workbox.ExpirationPlugin({
      maxEntries: 50,
      maxAgeSeconds: 5184000
